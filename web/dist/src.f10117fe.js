...
function () {
  ...
  View.prototype.onRender = function () {}; // burayı sor this.parent.innerHTML = '';  bunu ekleyince nasıl aynısından üretmeyi bıraktı?


  View.prototype.render = function () {
    this.parent.innerHTML = '';
    var templeteElement = document.createElement('template');
...
exports.Attributes = Attributes; //bura
...
var Collection_1 = require("./Collection"); //143. ve 156. video yu tekrar izle 
...
exports.User = User;
},{"./Eventing":"src/models/Eventing.ts","./Attributes":"src/models/Attributes.ts","./Model":"src/models/Model.ts","./ApiSync":"src/models/ApiSync.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
